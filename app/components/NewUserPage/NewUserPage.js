      ...
      >
        {state => (
          ...
          >
            ...
            >
              <h1 style={{ fontSize: 37 }}>Welcome to ArsenalLauncher!</h1>
              <div style={{ display: 'flex' }}>
                <p style={{ fontSize: 25 }}>
                  Hello {props.username}!<br />
                  ArsenalLauncher is free and open source, it wouldn't exist without
                ...
                <iframe
                  ...
                  src="https://discordapp.com/widget?id=440218616302927882&theme=dark"
                  width="350"
                  height="515"
